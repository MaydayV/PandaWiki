...
// PromptHeader is the preset prompt header template used when enable_preset is true.
// It provides the common prefix for system-built prompts based on toggle settings.
